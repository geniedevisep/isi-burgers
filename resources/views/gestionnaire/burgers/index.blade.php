    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="h3">Gestion des Burgers</h1>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $burger->stock }}</td>
                                    <td>
                                        <span class="badge {{ $burger->archived ? 'bg-warning' : 'bg-success' }}">
                                            {{ $burger->archived ? 'Archivé' : 'Actif' }}
                                        </span>
                                    </td>
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <form action="{{ route('gestionnaire.burgers.destroy', $burger) }}"
                                                  method="POST"
                                                  class="d-inline">
                                                @csrf
                                                @method('DELETE')
